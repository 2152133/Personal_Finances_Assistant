                ...
                <div class="card-body">
                    <form enctype="multipart/form-data" action="{{ route('register') }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input autofocus="" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" id="phone" name="phone" required="" type="text" value="{{ old('phone') }}">
                                    @if ($errors->has('phone'))
                                    <span class="invalid-feedback">
                                        <strong>
                                            {{ $errors->first('phone') }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input autofocus="" class="form-control{{ $errors->has('profile_photo') ? ' is-invalid' : '' }}" id="profile_photo" name="profile_photo" type="file" value="{{ old('profile_photo') }}">
